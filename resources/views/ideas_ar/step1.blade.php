     ...
     <style>
        ...
        label{
            ...
            border-radius: 0 5px 5px 0!important;
             border-right:1px solid #80808047!important;
        }#phone{
...
<div id="header" class="header">
    ...
    <div class="content-wrapper">
        ...
        <ul id="nav" style="display: inline-block;float:left;margin-top: 1.4rem;">
            <li style="display: inline-block;"><a href="{{route('language.change' , 'en')}}" style="text-decoration: none;font-size:18px;color:black">EN </a></li>
            ...
            <div class="left form-content">
                ...
                <div class="text-wrapper">
                    <p>فريق دافيسون ساعد الناس بتحقيق أفكارهم لأكثر من 30 عامًا
                        <br>
                        زطريقتنا في متناول اليد لتحويل أفكار منتجاتهم أو تطبيقاتهم إلى منتجات حقيقية على أرض الواقع. املأ نموذج تقديم الفكرة ,سنرسل لك معلومات مجانية حتى تتمكن من البدء بفكرتك
                    </p>
                </div>
                <hr>
                ...
                <div class="form">
                    ...
                    <form id="form" class="form-base" action="{{route('step2')}}">
                        ...
                        <fieldset class="pair">
                            ...
                            <div>
                                <label for="phone" style="float: right;">الهاتف</label><br>
                                ...
                                @elseif(Session::get('country_name') == 'Hashemite Kingdom of Jordan')
                                 <div class="input-group">
                                    ...
                                    <input id="phone" type="text" class="form-control" name="phone" value="{{Session::get('phone')}}" tabindex="9" placeholder="0702113311" style="height: 38px;">
                                 </div>
                                ...
                                @endif
                                @error('phone')
                                <span style="color: red; font-size: 16px;float: right;">تحقق من الرقم</span>
                                @enderror
                            </div>
                            <div>
                        ...
                        <fieldset class="submit" style="
                            ...
                            <div>
                                ...
                                <button type="submit"  class="action-button btnStep1" id="step1" style="padding-right: 1rem!important;"><p id="next" class="align-middle">التالي</p><i class="fas fa-caret-left" style="font-size: -17px;margin-right: 51px;font-size: 25px;" id="arrow "></i> </button>
                            </div>
